...
def get_data_system(emp,from_date,to_date):
    ...
    data += "<tr><td style = 'border: 1px solid black;background-color:#bbb7db'><b>ID</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>%s</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>Name</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>%s</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>Dept</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'colspan=2><b>%s</b></td></tr>"%(emp,emp_details[0],emp_details[1])
    ...
    data += "<tr><td style = 'border: 1px solid black;background-color:#bbb7db'><b>Date</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>Day</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>Working</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>In Time</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>Out Time</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b>Status</b></td><td style = 'border: 1px solid black;background-color:#bbb7db;'><b><center>OT Hours</center></b></td></tr>"
