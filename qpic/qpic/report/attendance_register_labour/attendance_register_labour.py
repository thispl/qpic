...
def get_employees(filters):
    ...
    left_employees = frappe.db.sql("""select name, employee_name, department, date_of_joining from `tabEmployee` where status = 'Left' and relieving_date >= '%s' order by department  %s """ %(filters.from_date,conditions),as_dict=True)
