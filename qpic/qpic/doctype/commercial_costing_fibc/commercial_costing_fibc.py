...
class CommercialCostingFIBC(Document):
    def validate(self):
        ...
        for i in opp:
            for opp_item in self.commercial_costing_item:
                ...
                if tc_id:
                    ...
                    doc.city = self.city
                    doc.commercial_costing_fibc = self.name
                    doc.technical_sheet_fibc = self.technical_sheet_fibc
                    self.commercial_costing_fibc = doc.name
                ...
                if not tc_id:
                    ...
                    tc.commercial_costing_fibc = self.name
                    tc.technical_sheet_fibc = self.technical_sheet_fibc
